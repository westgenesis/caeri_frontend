<template>
    <div style="margin: 20px;">
      ...
      <div style="display: flex; justify-content: space-between; align-items: start; margin-bottom: 1rem;">
        <div style="width: 200px;">
          ...
          <a-menu mode="inline" v-model:selectedKeys="selectedLabelGroup" @click="fetchLabelList">
            <a-menu-item v-for="group in labelGroupList" :key="group.label_group_id">
              ...
              <a-button type="link" @click.stop="showEditLabelGroupModal(group)">编辑</a-button>
              <a-button type="link" @click.stop="deleteLabelGroup(group.label_group_id)">删除</a-button>
            </a-menu-item>
          </a-menu>
        ...
        <div style="flex-grow: 1; padding-left: 20px;">
          ...
          <a-table :columns="columns" :dataSource="pagedLabelList" :rowKey="record => record.label_id" :pagination="paginationConfig" style="margin-top: 20px;">
        ...
        <a-form :form="createForm" :label-col="{ span: 4 }" :wrapper-col="{ span: 20 }" labelAlign="left">
          ...
          <a-form-item label="颜色" name="color">
            <a-radio-group v-model:value="createFormData.color">
              <a-radio :value="'#f5222d'"><div style="background-color: #f5222d; width: 30px; height: 24px; "></div></a-radio>
              <a-radio :value="'#fa8c16'"><div style="background-color: #fa8c16; width: 30px; height: 24px; "></div></a-radio>
              <a-radio :value="'#fadb14'"><div style="background-color: #fadb14; width: 30px; height: 24px; "></div></a-radio>
              <a-radio :value="'#1890ff'"><div style="background-color: #1890ff; width: 30px; height: 24px; "></div></a-radio>
              <a-radio :value="'#ffffff'"><div style="background-color: #ffffff; width: 30px; height: 24px;  border: 1px solid #d9d9d9;"></div></a-radio>
              <a-radio :value="'#52c41a'"><div style="background-color: #52c41a; width: 30px; height: 24px; "></div></a-radio>
              <a-radio :value="'#13c2c2'"><div style="background-color: #13c2c2; width: 30px; height: 24px; "></div></a-radio>
              <a-radio :value="'#fa541c'"><div style="background-color: #fa541c; width: 30px; height: 24px; "></div></a-radio>
            </a-radio-group>
          </a-form-item>
  ...
  export default {
    ...
    return {
      ...
      createModalVisible,
      editModalVisible,
      createLabelGroupModalVisible,
      editLabelGroupModalVisible,
      createFormData,
      editFormData,
      createLabelGroupFormData,
      editLabelGroupFormData,
      columns,
      paginationConfig,
      fetchLabelList,
      showCreateModal,
      ...
      updateLabel,
      deleteLabel,
      showCreateLabelGroupModal,
      createLabelGroup,
      showEditLabelGroupModal,
      updateLabelGroup,
      deleteLabelGroup,
      handleCancel,
      pagedLabelList,
